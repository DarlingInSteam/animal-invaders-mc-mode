...
public class BobrittoBanditoLeaderModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public BobrittoBanditoLeaderModel(ModelPart root) {
		this.bobritto = root.getChild("bobritto");
		this.body = this.bobritto.getChild("body");
		this.leg1 = this.bobritto.getChild("leg1");
		this.leg2 = this.bobritto.getChild("leg2");
		this.head = this.bobritto.getChild("head");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bobritto = partdefinition.addOrReplaceChild("bobritto", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r1 = mouth.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(68, 1).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.75F, -0.25F, -0.3927F, 0.48F, 0.0F));
		...
		PartDefinition gun = head.addOrReplaceChild("gun", CubeListBuilder.create().texOffs(3, 70).addBox(-2.25F, -1.0F, -0.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(14, 73).addBox(8.25F, -2.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.25F, 0.75F, 9.25F, -3.081F, -1.3679F, 2.7347F));

		PartDefinition cube_r2 = gun.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(39, 86).addBox(-5.0F, 0.0F, -0.4F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.25F, -1.0F, 0.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition cube_r3 = gun.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(28, 85).addBox(-2.1F, 0.0F, -0.4F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -0.5F, 0.0F, 0.0F, 0.0F, -1.1345F));

		PartDefinition cube_r4 = gun.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(7, 76).addBox(-3.5F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.25F, 0.25F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition magazine = gun.addOrReplaceChild("magazine", CubeListBuilder.create().texOffs(3, 80).addBox(-0.5F, 0.25F, -1.4F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(1.25F, -0.5F, 0.0F));
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		// Используем те же анимации, что и для обычного Бобритто, но с более высокой скоростью
		this.animateWalk(BobrittoBanditoAnimationsDefinitions.Walk, limbSwing, limbSwingAmount, 2.2f, 2.7f);
		
		// Используем обычные анимационные состояния, независимо от типа сущности
		BobrittoBanditoEntity bobrito = (BobrittoBanditoEntity) entity;
		this.animate(bobrito.idleAnimationState, BobrittoBanditoAnimationsDefinitions.Idle, ageInTicks, 1f);
		this.animate(bobrito.attackAnimationState, BobrittoBanditoAnimationsDefinitions.Shooting, ageInTicks, 1f);
		this.animate(bobrito.runAnimationState, BobrittoBanditoAnimationsDefinitions.Run, ageInTicks, 1.1f);
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		bobritto.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
